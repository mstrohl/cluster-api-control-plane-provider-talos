...
// local fork adding OpenStack (CAPO) infrastructure provider support for e2e tests;
// see hack/vendor/capi-utils/pkg/capi/infrastructure/openstack.go
replace github.com/siderolabs/capi-utils => ./hack/vendor/capi-utils
